...
function bot() {
    ...
    var schemes = {
        ...
        'cloudyDay':
        {'skyFromColour': [214.0, 234.0, 243.0],
            'skyToColour': [85.0, 93.0, 104.0],
            'showLeaves': true,
            'leafColour': [79, 156, 26],
            'showGrass': true,
            'treeColour': [96, 89, 57],
            'grassColour': [51, 157, 72],
            'groundColour': [6, 60, 14],
            'rainIntensity': 0.0,
            'text': 'A cloudy sky dulls the otherwise fine day.'
        },
        'clearDayLateAfternoon':
        {'skyFromColour': [49.0, 132.0, 226.0],
            'skyToColour': [183.0, 218.0, 242.0],
            'showLeaves': true,
            'leafColour': [79, 156, 26],
            'showGrass': true,
            'treeColour': [96, 89, 57],
            ...
            'groundColour': [6, 60, 14],
            'rainIntensity': 0.0,
            'text': 'Late afternoon sun tints the summer scene.'
        },
        'rainyAutumn':
        {'skyFromColour': [235.0, 123.0, 110.0],
            ...
            'rainIntensity': 0.4,
            'text': 'Raindrops drip off the autumn leaves.'
        },
        'snowy':
        {'skyFromColour': [212.0, 225.0, 231.0],
            ...
            'rainIntensity' : 0.0,
            'text': 'Heavy layers of snow blanket the ground. The tree stands bare in winter\'s chill.'
        }
    };
    
    var possibleSchemes = ['snowy', 'cloudyDay', 'clearDayLateAfternoon', 'rainyAutumn'];
    ...
    this.generateScheme = function(weatherData) {
        ...
        if (tempCelsius > 28) {
            temperatureText = 'It\'s a blisteringly hot day. '
        } else if (tempCelsius > 20) {
            temperatureText = 'It\'s a hot day. ';
        } else if (tempCelsius > 16) {
            temperatureText = 'It\'s a warm day. ';
        } else if (tempCelsius > 8) {
            temperatureText = 'It\'s a cool day. ';
        } else if (tempCelsius > 0) {
            temperatureText = 'It\'s a cold day. ';
        } else {
            temperatureText = 'It\'s a freezing cold day. '
        }
    ...
    this.respond = function() {
        ...
        return this.parameters.text; //JSON.stringify(this.weatherData, null, 2);
    }
}
