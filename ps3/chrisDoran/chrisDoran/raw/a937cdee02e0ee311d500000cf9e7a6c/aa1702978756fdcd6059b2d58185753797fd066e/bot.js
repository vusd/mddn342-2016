...
function bot() {
  ...
  this.grammar = {
    ...
    "Brand": ["Apple", "Google", "Microsoft", "Coca-Cola", "Facebook", "Toyota", "IBM", "Disney", "GE", "Samsung", "Amazon", "BMW", "Intel", "Nike", "Louis Vuitton", "Mercedes-Benz", "Walmart", "Marlboro", "Pepsi", "Visa", "L'Oreal", "Ford", "Audi", "HP", "Starbucks", "Nestle", "Fox", "Chevrolet", "Colgate", "Kellogg's", "Rolex", "Porsche", "Nissan", "Adobe", "Atari", "Ray Bans", "Country Road", "Halenstines", "Cotton-On", "Barkers", "Nintendo", "Trojan", "Durex", "Pantene", "Sony", "Adidas", "Reebok"]
  }
  ...
  this.respond = function() {
    ...
    if(tweetContent != null){
      ...
      message = "I acknowledge you, my Master, my God, with all my heart. I will honor your name for a long time";
    }
    ...
    else if (message.search("the Lord") >= 0){
      var result = message.replace("the Lord", brand);
    }
    else if (message.search("The Lord") >= 0){
      var result = message.replace("The Lord", brand);
    }

    //draw Rect backgrouda
    rectMode(CENTER);
    noStroke();
    fill(20, 130);
    rect(220, 110, 440, 90);
